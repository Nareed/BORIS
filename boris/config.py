...
MEDIA_FILE_PATH_IDX = 3
MEDIA_DURATION_IDX = 4
MEDIA_FPS_IDX = 5
HAS_VIDEO_IDX = 6
HAS_AUDIO_IDX = 7
...
OFFICIAL_PLUGINS_DIR = "official_plugins_dir"
OFFICIAL_PLUGINS_SOURCE = "official_plugins_source"
OFFICIAL_PLUGINS_ENV_VAR = "BORIS_PLUGINS_DIR"
OFFICIAL_PLUGINS_REPO_NAME = "BORIS_plugins"
OFFICIAL_PLUGINS_REPO_URL = "https://github.com/olivierfriard/BORIS_plugins"
OFFICIAL_PLUGINS_RELEASES_API_URL = "https://api.github.com/repos/olivierfriard/BORIS_plugins/releases"
OFFICIAL_PLUGINS_REPO_BRANCH = "main"
OFFICIAL_PLUGINS_ARCHIVE_URL = f"{OFFICIAL_PLUGINS_REPO_URL}/archive/refs/heads/{OFFICIAL_PLUGINS_REPO_BRANCH}.zip"
OFFICIAL_PLUGINS_SOURCE_BRANCH = "branch"
OFFICIAL_PLUGINS_SOURCE_RELEASE = "release"
